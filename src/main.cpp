...
uint256 hashGenesisBlock("0x46853f877bfe26415f2612495f6d9c1442ced1896f6124bfdee7c7bb31aa2a29");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(503925994); // ChickenBaconRanch: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "ChickenBaconRanch Signed Message:\n";
...
{
    // ChickenBaconRanch: IsDust() detection disabled, allows any valid dust to be relayed.
...
{
    int64 nSubsidy = 42000000000000;

    // Subsidy is cut in half every 840000 blocks, which will occur approximately every 4 years
    nSubsidy >>= (nHeight / 420); // ChickenBaconRanch: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 63000; // ChickenBaconRanch: 3.5 days
static const int64 nTargetSpacing = 150; // ChickenBaconRanch: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // ChickenBaconRanch: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // ChickenBaconRanch: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // ChickenBaconRanch: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xe0b0511c1e48e9713f31421fd7fd8a68a0045b51ff90a7cee2343b26ad48f0d9");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        txNew.vout[0].nValue = 42000000000000;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("f52c55ca91e78c9b656ec35870555cb964baa42f0f7a53685c9b1bd54f8bad1f09b908d90488a572450e132d79d3166269beae77c573b6bfdb22b63043a61da2be") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1444682702;
        block.nBits    = 503925994;
        block.nNonce   = 2090873003;

        if (fTestNet)
        {
            block.nTime    = 1444682702;
            block.nNonce   = 2322507695;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x314fca7690c72cc8e5e32d1660bdb88024c3475b17798291865b477993a92dbe"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // ChickenBaconRanch: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    //// debug print
    printf("ChickenBaconRanch RPCMiner:\n");
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("ChickenBaconRanchMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("ChickenBaconRanchMiner : ProcessBlock, block not accepted");
    }
